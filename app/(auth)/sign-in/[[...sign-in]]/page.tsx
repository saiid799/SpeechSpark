      ...
      <div className="space-y-4">
        ...
        <div className="text-center space-y-2 mb-4">
          <div className="flex items-center justify-center space-x-2 text-primary">
            ...
            <span className="text-xs font-medium uppercase tracking-wider">Continue Learning</span>
            <div className="w-1.5 h-1.5 bg-primary rounded-full animate-pulse"></div>
          </div>
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          <div className="p-2 rounded-lg bg-primary/5 border border-primary/10 text-center">
            ...
            <p className="text-xs text-foreground/70 font-medium">Progress</p>
          </div>
          <div className="p-2 rounded-lg bg-secondary/5 border border-secondary/10 text-center">
            <div className="text-sm mb-1">🎓</div>
            <p className="text-xs text-foreground/70 font-medium">Lessons</p>
          </div>
          <div className="p-2 rounded-lg bg-accent/5 border border-accent/10 text-center">
            <div className="text-sm mb-1">🏆</div>
            <p className="text-xs text-foreground/70 font-medium">Awards</p>
          </div>
        </div>
