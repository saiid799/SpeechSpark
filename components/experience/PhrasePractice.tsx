...
const PhrasePractice: React.FC<PhrasePracticeProps> = ({
  ...
  useEffect(() => {
    fetchPhrases(`/api/words/phrases/${encodeURIComponent(word)}`);
  }, [word, fetchPhrases]);
  ...
  const handleSubmit = useCallback(() => {
    ...
    const isAnswerCorrect =
      ...
      currentPhrase.form.toLowerCase().trim();
          ...
          {currentPhrase && (
            <>
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-4 mb-6">
                ...
                <Button
                  onClick={() =>
                    handleSpeak(currentPhrase.form, learningLanguage)
                  }
                  disabled={speaking}
              ...
              {showTranslation && (
                ...
                >
                  ...
                  <p className="text-xl">{currentPhrase.form}</p>
                  <Button
                    onClick={() =>
                      handleSpeak(currentPhrase.form, learningLanguage)
                    }
